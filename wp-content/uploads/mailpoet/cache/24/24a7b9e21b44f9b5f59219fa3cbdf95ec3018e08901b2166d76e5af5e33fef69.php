...
/* welcome_wizard.html */
class __TwigTemplate_f4a2401e466ae55c9336ca320a1cb723bcb0c1ce6217649861c5021fe5545553 extends Twig_Template
{
  ...
  var is_mp2_migration_complete = ";
        // line 7
        echo json_encode((isset($context["is_mp2_migration_complete"]) ? $context["is_mp2_migration_complete"] : null));
        echo ";
  ...
  var finish_wizard_url = '";
        // line 9
        echo twig_escape_filter($this->env, (isset($context["finish_wizard_url"]) ? $context["finish_wizard_url"] : null), "html", null, true);
        echo "';
  var sender_data = ";
        // line 10
        echo json_encode((isset($context["sender"]) ? $context["sender"] : null));
        echo ";
</script>
...
";
    ...
    {
        return new Twig_Source("", "welcome_wizard.html", "/home/demoapp/public_html/yourforexjourney/theme2/wp-content/plugins/mailpoet/views/welcome_wizard.html");
    }
}

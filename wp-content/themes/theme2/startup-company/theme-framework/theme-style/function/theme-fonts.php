...
function startup_company_theme_fonts() {
...
/***************** Start Theme Font Styles ******************/
	...
	.footer .social_wrap a {
		width:" . ((int) $cmsmasters_option['startup-company' . '_content_font_line_height'] + 2) . "px;
		height:" . ((int) $cmsmasters_option['startup-company' . '_content_font_line_height'] + 2) . "px;
	}
	...
	#wp-calendar tbody td {
		...
		line-height:" . ((int) $cmsmasters_option['startup-company' . '_link_font_line_height'] - 1) . "px;
	}
	...
	.cmsmasters_likes a,
	.cmsmasters_comments a {
		font-size:" . ((int) $cmsmasters_option['startup-company' . '_link_font_font_size'] - 2) . "px;
		line-height:" . ((int) $cmsmasters_option['startup-company' . '_link_font_line_height'] - 2) . "px;
	}
	...
	a:hover {
		text-decoration:" . $cmsmasters_option['startup-company' . '_link_hover_decoration'] . ";
	}
	/* Finish Link Font */
	...
	nav > div > ul div.menu-item-mega-container > ul > li > a {
		font-family:" . startup_company_get_google_font($cmsmasters_option['startup-company' . '_nav_title_font_google_font']) . $cmsmasters_option['startup-company' . '_nav_title_font_system_font'] . ";
		font-size:" . $cmsmasters_option['startup-company' . '_nav_title_font_font_size'] . "px;
		line-height:" . $cmsmasters_option['startup-company' . '_nav_title_font_line_height'] . "px;
		font-weight:" . $cmsmasters_option['startup-company' . '_nav_title_font_font_weight'] . ";
		font-style:" . $cmsmasters_option['startup-company' . '_nav_title_font_font_style'] . ";
		text-transform:" . $cmsmasters_option['startup-company' . '_nav_title_font_text_transform'] . ";
	}
	
	.top_line_nav > li > a {
		font-size:" . ((int) $cmsmasters_option['startup-company' . '_nav_title_font_font_size'] - 1) . "px;
	}
	...
	@media only screen and (max-width: 1024px) {
		...
		ul.top_line_nav ul li a {
			font-family:" . startup_company_get_google_font($cmsmasters_option['startup-company' . '_nav_title_font_google_font']) . $cmsmasters_option['startup-company' . '_nav_title_font_system_font'] . ";
			font-size:" . ((int) $cmsmasters_option['startup-company' . '_nav_title_font_font_size'] - 2) . "px;
			line-height:" . $cmsmasters_option['startup-company' . '_nav_title_font_line_height'] . "px;
			font-weight:" . $cmsmasters_option['startup-company' . '_nav_title_font_font_weight'] . ";
			font-style:" . $cmsmasters_option['startup-company' . '_nav_title_font_font_style'] . ";
			text-transform:" . $cmsmasters_option['startup-company' . '_nav_title_font_text_transform'] . ";
	...
	@media only screen and (max-width: 1024px) {
		...
		#header nav > div > ul div.menu-item-mega-container > ul > li > a .cmsmasters_resp_nav_toggle {
			line-height:" . $cmsmasters_option['startup-company' . '_nav_title_font_line_height'] . "px;
			width:" . $cmsmasters_option['startup-company' . '_nav_title_font_line_height'] . "px;
			height:" . $cmsmasters_option['startup-company' . '_nav_title_font_line_height'] . "px;
		}
	}
	...
	.top_line_nav ul li a {
		font-family:" . startup_company_get_google_font($cmsmasters_option['startup-company' . '_nav_dropdown_font_google_font']) . $cmsmasters_option['startup-company' . '_nav_dropdown_font_system_font'] . ";
		font-size:" . $cmsmasters_option['startup-company' . '_nav_dropdown_font_font_size'] . "px;
		line-height:" . $cmsmasters_option['startup-company' . '_nav_dropdown_font_line_height'] . "px;
		font-weight:" . $cmsmasters_option['startup-company' . '_nav_dropdown_font_font_weight'] . ";
		font-style:" . $cmsmasters_option['startup-company' . '_nav_dropdown_font_font_style'] . ";
		text-transform:" . $cmsmasters_option['startup-company' . '_nav_dropdown_font_text_transform'] . ";
	}
	
	@media only screen and (max-width: 1024px) {
		#header .navigation ul li a .cmsmasters_resp_nav_toggle {
			line-height:" . $cmsmasters_option['startup-company' . '_nav_dropdown_font_line_height'] . "px;
			width:" . $cmsmasters_option['startup-company' . '_nav_dropdown_font_line_height'] . "px;
			height:" . $cmsmasters_option['startup-company' . '_nav_dropdown_font_line_height'] . "px;
		}
	}
	...
	.cmsmasters_counters .cmsmasters_counter_wrap .cmsmasters_counter .cmsmasters_counter_inner .cmsmasters_counter_counter_wrap {
		font-size:" . ((int) $cmsmasters_option['startup-company' . '_h1_font_font_size'] + 6) . "px;
		line-height:" . ((int) $cmsmasters_option['startup-company' . '_h1_font_line_height'] + 6) . "px;
	}
	
	.cmsmasters_stats.stats_mode_circles .cmsmasters_stat_wrap .cmsmasters_stat .cmsmasters_stat_inner .cmsmasters_stat_counter_wrap {
		font-size:" . ((int) $cmsmasters_option['startup-company' . '_h1_font_font_size'] - 4) . "px;
		line-height:" . ((int) $cmsmasters_option['startup-company' . '_h1_font_line_height'] - 4) . "px;
	}
	...
	.headline_outer .headline_inner .headline_icon:before {
		font-size:" . ((int) $cmsmasters_option['startup-company' . '_h1_font_font_size'] - 10) . "px;
		line-height:" . $cmsmasters_option['startup-company' . '_h1_font_line_height'] . "px;
		height:" . $cmsmasters_option['startup-company' . '_h1_font_line_height'] . "px;
	}
	
	.headline_outer .headline_inner.align_left .headline_icon,
	.headline_outer .headline_inner.align_left .headline_icon + .cmsmasters_breadcrumbs {
		padding-left:" . ((int) $cmsmasters_option['startup-company' . '_h1_font_font_size'] + 5) . "px;
	}
	
	.headline_outer .headline_inner.align_right .headline_icon,
	.headline_outer .headline_inner.align_right .headline_icon + .cmsmasters_breadcrumbs {
		padding-right:" . ((int) $cmsmasters_option['startup-company' . '_h1_font_font_size'] + 5) . "px;
	}
	
	.headline_outer .headline_inner.align_center .headline_icon {
		padding-left:" . ((int) $cmsmasters_option['startup-company' . '_h1_font_font_size'] + 5) . "px;
		margin-left:-" . ((int) $cmsmasters_option['startup-company' . '_h1_font_font_size'] + 5) . "px;
	}
	/* Finish H1 Font */
	...
	.gform_wrapper .gform_footer input[type=submit] {
		font-size:" . $cmsmasters_option['startup-company' . '_button_font_font_size'] . "px !important;
	}
	...
	.cmsmasters_button.cmsmasters_but_icon_inverse {
		padding-left:" . ((int) $cmsmasters_option['startup-company' . '_button_font_line_height'] + 20) . "px;
	}
	...
	.cmsmasters_button.cmsmasters_but_icon_inverse:after {
		width:" . $cmsmasters_option['startup-company' . '_button_font_line_height'] . "px;
	}
	/* Finish Button Font */
	...
	.gform_wrapper .instruction {
		font-family:" . startup_company_get_google_font($cmsmasters_option['startup-company' . '_small_font_google_font']) . $cmsmasters_option['startup-company' . '_small_font_system_font'] . " !important;
		font-size:" . $cmsmasters_option['startup-company' . '_small_font_font_size'] . "px !important;
		line-height:" . $cmsmasters_option['startup-company' . '_small_font_line_height'] . "px !important;
	}
	...
	.gform_wrapper select {
		font-size:" . $cmsmasters_option['startup-company' . '_input_font_font_size'] . "px !important;
	}
	...
	.cmsmasters_quotes_grid .cmsmasters_quote_content {
		font-family:" . startup_company_get_google_font($cmsmasters_option['startup-company' . '_quote_font_google_font']) . $cmsmasters_option['startup-company' . '_quote_font_system_font'] . ";
		font-size:" . $cmsmasters_option['startup-company' . '_quote_font_font_size'] . "px;
		line-height:" . $cmsmasters_option['startup-company' . '_quote_font_line_height'] . "px;
		font-weight:" . $cmsmasters_option['startup-company' . '_quote_font_font_weight'] . ";
		font-style:" . $cmsmasters_option['startup-company' . '_quote_font_font_style'] . ";
	}
	
	.cmsmasters_quotes_grid .cmsmasters_quote_content {
		font-size:" . ((int) $cmsmasters_option['startup-company' . '_quote_font_font_size'] - 6) . "px;
		line-height:" . ((int) $cmsmasters_option['startup-company' . '_quote_font_line_height'] - 6) . "px;
	}
...
";
	...
	return apply_filters('startup_company_theme_fonts_filter', $custom_css);
}

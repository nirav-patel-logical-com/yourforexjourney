...
function startup_company_event_meta_info_col_num() {
	$col_num = 1;
...
$cmsmasters_event_meta_info_col = 'cmsmasters_event_meta_info_col_' . startup_company_event_meta_info_col_num();

...
function startup_company_woocommerce_register_styles_scripts() {
	...
	$cmsmasters_image_sizes = startup_company_get_image_thumbnail_list();
...
function startup_company_woocommerce_demo_store($html, $notice) {
...
add_filter('woocommerce_demo_store', 'startup_company_woocommerce_demo_store', 10, 2);


function startup_company_woocommerce_support() {
...
add_action('after_setup_theme', 'startup_company_woocommerce_support');

...
/* Filter for Options */
function startup_company_woocommerce_meta_fields($custom_all_meta_fields) {
...
add_filter('get_custom_all_meta_fields_filter', 'startup_company_woocommerce_meta_fields');

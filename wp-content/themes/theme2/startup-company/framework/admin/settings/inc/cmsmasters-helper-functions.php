...
function startup_company_get_admin_page() {
	global $pagenow;
...
function startup_company_default_tab() {
	$current_page = startup_company_get_admin_page();
...
function startup_company_get_the_tab() {
	global $pagenow;
	
	$default_tab = startup_company_default_tab();
...
function startup_company_settings_page_header() {

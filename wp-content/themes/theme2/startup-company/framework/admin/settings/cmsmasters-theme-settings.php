...
function startup_company_settings_scripts() {
	...
	wp_localize_script('startup-company-settings-js', 'cmsmasters_setting', array( 
		...
		'remove_sidebar' => 				esc_html__('Do you really want to remove this sidebar?', 'startup-company'), 
		'find' => 							esc_attr__('Find icons', 'startup-company'), 
		'remove_icon' => 					esc_html__('Do you really want to remove this social icon?', 'startup-company'), 

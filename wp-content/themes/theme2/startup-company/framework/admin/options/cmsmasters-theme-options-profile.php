...
if (!function_exists('startup_company_get_custom_profile_meta_fields')) {
function startup_company_get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_title = (isset($cmsmasters_option['startup-company' . '_profile_post_title']) && $cmsmasters_option['startup-company' . '_profile_post_title'] !== '') ? (($cmsmasters_option['startup-company' . '_profile_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option['startup-company' . '_profile_post_details_title']) && $cmsmasters_option['startup-company' . '_profile_post_details_title'] !== '') ? $cmsmasters_option['startup-company' . '_profile_post_details_title'] : '';
	
	$cmsmasters_global_profile_post_share_box = (isset($cmsmasters_option['startup-company' . '_profile_post_share_box']) && $cmsmasters_option['startup-company' . '_profile_post_share_box'] !== '') ? (($cmsmasters_option['startup-company' . '_profile_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	...
	$tabs_array['cmsmasters_profile'] = array( 
		'label' => esc_html__('Profile', 'startup-company'), 
	...
	$custom_profile_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Profile Title', 'startup-company'), 
		...
		array( 
			'label'	=> esc_html__('Subtitle', 'startup-company'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Details Title', 'startup-company'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Social Icons', 'startup-company'), 
			'desc'	=> esc_html__('Add social icons for this profile', 'startup-company'), 
		...
		array( 
			'label'	=> esc_html__('Profile Info', 'startup-company'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1 Title', 'startup-company'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1', 'startup-company'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2 Title', 'startup-company'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2', 'startup-company'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3 Title', 'startup-company'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3', 'startup-company'), 
			'desc'	=> '', 
